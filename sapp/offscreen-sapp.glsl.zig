...
//
//    Cmdline:
//        sokol-shdc -i sapp/offscreen-sapp.glsl -o sapp/offscreen-sapp.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
...
//
//
const vs_offscreen_source_glsl430 = [280]u8 {
...
//
//
const fs_offscreen_source_glsl430 = [166]u8 {
...
//
//
const vs_default_source_glsl430 = [400]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x76,0x73,0x5f,0x70,0x61,
    0x72,0x61,0x6d,0x73,0x5b,0x34,0x5d,0x3b,0x0a,0x6c,0x61,0x79,0x6f,0x75,0x74,0x28,
    0x6c,0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x20,0x3d,0x20,0x30,0x29,0x20,0x69,0x6e,
...
//
//
const fs_default_source_glsl430 = [399]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x33,0x30,0x0a,0x0a,0x6c,0x61,
...
pub fn defaultShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.source = &vs_default_source_glsl430;
            desc.vs.entry = "main";
            ...
            desc.fs.source = &fs_default_source_glsl430;
            desc.fs.entry = "main";
...
pub fn offscreenShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    ...
    switch (backend) {
        .GLCORE => {
            ...
            desc.vs.uniform_blocks[0].uniforms[0].type = .FLOAT4;
            desc.vs.uniform_blocks[0].uniforms[0].array_count = 4;
            desc.fs.source = &fs_offscreen_source_glsl430;
            desc.fs.entry = "main";
        },
        .GLES3 => {
            desc.attrs[0].name = "position";
