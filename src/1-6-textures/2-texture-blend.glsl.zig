...
//
//    Cmdline:
//        sokol-shdc -i src/1-6-textures/2-texture-blend.glsl -o src/1-6-textures/2-texture-blend.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
