...
//
//    Cmdline:
//        sokol-shdc -i src/1-8-coordinate-systems/shaders.glsl -o src/1-8-coordinate-systems/shaders.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig
//
//    Overview:
//    =========
